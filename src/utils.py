...
from data_utils import CPRDataset
...
def extract_index_features(dataset: Union[CPRDataset], clip_model: CLIP) -> \
    Tuple[torch.tensor, List[str]]:

    """
    Extract CPRDataset index features
    :param dataset: CPRDataset dataset in 'classic' mode
    ...
    if isinstance(dataset, CPRDataset):
        print(f"extracting {dataset.dataset_name} {dataset.split} index features")
