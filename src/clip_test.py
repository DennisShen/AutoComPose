...
def clip_test_cpr(dataset: str, experiment_name: str, clip_model_name: str, transform: str, val_split: str, **kwargs):
    """
    Fine-tune CLIP on a CPR dataset using "image-text element-wise sum" as the combining function
    :param dataset: CPR dataset to use, should be in ['posefix', 'aist', 'posefix', 'uavhuman', 'milcpr']
    ...
    with experiment.validate():
        ...
        results = compute_cpr_val_metrics(relative_val_dataset, clip_model, val_index_features, val_index_names, combining_function, keep_selection)
...
if __name__ == '__main__':
    ...
    clip_test_cpr(**training_hyper_params)
